...
import {
  GridCellLayerFormSchema,
  GridCellLayerFormSchemaType,
} from "./schema/GridCellLayerFormSchema";

function GridCellLayerForm({ closeAllDialog }: { closeAllDialog: () => void }) {
  const setDeckLayers = useContext(SetDeckLayersContext);
  const { mainMap } = useMap();
  const form = useForm<GridCellLayerFormSchemaType>({
    resolver: zodResolver(GridCellLayerFormSchema),
    defaultValues: {
      id: "grid cell layer",
  ...
  const onSubmit = useCallback(
    (values: GridCellLayerFormSchemaType) => {
      ...
      toast.success("Add grid cell layer to map");
      closeAllDialog();
    },
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                This is your GridCellLayer source data.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  This is your GridCellLayer cellSize.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
...
export default GridCellLayerForm;
